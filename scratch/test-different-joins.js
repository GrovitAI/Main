...
async function testJoin() {
  const url = `${baseUrl}inventory_materials?select=*,category:inventory_categories(category_name),unit:inventory_units!inventory_unit_id(short_name),primary_unit:inventory_units!primary_unit_id(short_name)&limit=1`;
  try {
